...
select
  ct.cateid as cateid,
  ct.catename as catename,
  sct.subcateid as subcateid,
  sct.subcatename as subcatename
from
  category as ct
  left join sub_category as sct 
  on ct.cateid = sct.cateid
order by
  ct.cateid,
  sct.subcateid
) as test
on c.cateid = test.cateid and c.subcateid = test.subcateid;